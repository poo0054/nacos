...
public abstract class GrpcClient extends RpcClient {
    ...
    protected ThreadPoolExecutor createGrpcExecutor(String serverIp) {
        ...
        ThreadPoolExecutor grpcExecutor = new ThreadPoolExecutor(clientConfig.threadPoolCoreSize(),
            ...
            new LinkedBlockingQueue<>(clientConfig.threadPoolQueueSize()), new ThreadFactoryBuilder().daemon(true)
                .nameFormat("nacos-grpc-client-executor-" + serverIp + "-%d").build());
                    ...
                    if (request != null) {
                        ...
                        try {
                            ...
                            Response errResponse =
                                ErrorResponse.build(NacosException.CLIENT_ERROR, "Handle server request error");
