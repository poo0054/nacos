...
public class ServiceInfoHolder implements Closeable {
    ...
    private boolean isLoadCacheAtStart(NacosClientProperties properties) {
        ...
        if (properties != null
            ...
            loadCacheAtStart =
                ConvertUtils.toBoolean(properties.getProperty(PropertyKeyConst.NAMING_LOAD_CACHE_AT_START));
        }
    ...
    private boolean isPushEmptyProtect(NacosClientProperties properties) {
        ...
        if (properties != null
            ...
            pushEmptyProtection =
                ConvertUtils.toBoolean(properties.getProperty(PropertyKeyConst.NAMING_PUSH_EMPTY_PROTECTION));
        }
